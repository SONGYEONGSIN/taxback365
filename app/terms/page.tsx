  ...
  return (
    <div className="max-w-[680px] mx-auto animate-fade-in">
      <div className="mb-8">
        ...
        <h1 className="text-h1 text-ink-black">이용약관</h1>
      ...
      <Card padding="lg" className="space-y-10">
        <section>
          <h2 className="text-h3 text-ink-black mb-3">제1조 (목적)</h2>
        ...
        <section>
          <h2 className="text-h3 text-ink-black mb-3">제4조 (서비스 이용)</h2>
          <div className="space-y-3 text-body text-thunder-gray leading-[1.7]">
            <p>
              <strong className="text-ink-black">1. 서비스 이용 시간:</strong>{" "}
              서비스는 연중무휴 24시간 제공됨을 원칙으로 합니다. 다만, 시스템
              점검 등의 사유로 서비스가 일시 중단될 수 있습니다.
            </p>
            <p>
              <strong className="text-ink-black">2. 정보의 정확성:</strong>{" "}
              서비스에서 제공하는 예상 환급액 및 절세 정보는 이용자가 입력한
              정보를 기반으로 계산되며, 실제 국세청 확정 자료와 다를 수
              있습니다.
            </p>
            <p>
              <strong className="text-ink-black">3. 세무 상담:</strong> 본
        ...
        <section>
          <h2 className="text-h3 text-ink-black mb-3">제6조 (면책조항)</h2>
          <div className="rounded-md bg-warm-orange/8 border border-warm-orange/30 p-4">
            <p className="text-body text-thunder-gray leading-[1.7]">
        ...
        <section>
          <h2 className="text-h3 text-ink-black mb-3">제7조 (약관의 변경)</h2>
          <p className="text-body text-thunder-gray leading-[1.7]">
