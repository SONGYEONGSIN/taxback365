  ...
  return (
    <div className="max-w-[680px] mx-auto animate-fade-in">
      <div className="mb-8">
        ...
        <h1 className="text-h1 text-hi">이용약관</h1>
      ...
      <Card padding="lg" className="space-y-10">
        <section>
          <h2 className="text-h3 text-hi mb-3">제1조 (목적)</h2>
        ...
        <section>
          <h2 className="text-h3 text-hi mb-3">제2조 (서비스의 정의)</h2>
        ...
        <section>
          <h2 className="text-h3 text-hi mb-3">제3조 (이용계약의 성립)</h2>
          <p className="text-body text-mid leading-[1.7]">
        ...
        <section>
          <h2 className="text-h3 text-hi mb-3">제4조 (서비스 이용)</h2>
        ...
        <section>
          <h2 className="text-h3 text-hi mb-3">제5조 (이용자의 의무)</h2>
          <ul className="list-disc list-inside space-y-1.5 text-body text-mid ml-2">
        ...
        <section>
          <h2 className="text-h3 text-hi mb-3">제6조 (면책조항)</h2>
        ...
        <section>
          <h2 className="text-h3 text-hi mb-3">제7조 (약관의 변경)</h2>
          <p className="text-body text-mid leading-[1.7]">
