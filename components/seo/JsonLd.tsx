export function WebApplicationJsonLd() {
  const jsonLd = {
    ...
    "@type": "WebApplication",
    name: "taxback365",
    url: "https://taxback365.vercel.app",
    description:
...
export function FAQPageJsonLd() {
  const jsonLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "taxback365는 무료인가요?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "네, taxback365의 기본 연말정산 시뮬레이션 기능은 무료로 제공됩니다. 회원가입 후 바로 이용하실 수 있습니다.",
        },
      },
      {
        "@type": "Question",
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "taxback365는 2026년 세법 개정안을 반영하여 소득공제와 세액공제 항목을 분석합니다. 급여, 지출, 가족 정보를 입력하면 AI가 최적의 공제 전략과 예상 환급액을 계산해드립니다.",
        },
      },
      {
        "@type": "Question",
